...
## Module Requirements
The following sections document the requirements of this module. I was assigned the role of having a simple sensor, then being a floater to assist other teammates. On my PCB I will be using a temperature sensor. The goal of the temperature sensor is to be able to record changes in ambient water temperatures. This table contains the basic requirements, these being a microcontroller, power, and connectors to send information to teammates' boards.
